...
protocol FPCardCollectionViewCellDelegate: class {
    ...
    func optionPost(_ post: Post, _ button: UIButton, completion: (() -> Swift.Void)? )
}



class UserFeedCollectionViewCell: MDCCardCollectionCell {
    ...
    func populateContent(post: Post, index: Int, isDryRun: Bool) {
